...
class HeroController extends AbstractController
{
    ...
    {
        $herosDispo = $heroRepository->findHeroDisponible();
        return $this->render('hero/index.html.twig', ['heroes'=>$herosDispo]);
    }
    ...
    /**
     * @Route("/{id}/affecteHeroUser", name="affecteHeroUser", methods={"GET","POST"})
     */
    public function affecteHeroUser(Hero $hero): Response
    {
        // $HeroId = $hero->getId();
        $userID = $this->getUser();
        $hero->setUser($userID);
